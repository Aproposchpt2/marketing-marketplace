...
// Federal claims land on FCP's own workspace page, not a marketplace-hosted
...
// (fcp.aproposgroupllc.com) are different origins and sessionStorage does
// not cross origins.
assert.match(html,/https:\/\/fcp\.aproposgroupllc\.com\/federal-opportunity-workspace\.html\?t=/);
