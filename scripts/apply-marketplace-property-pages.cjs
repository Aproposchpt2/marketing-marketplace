...
const pages = [
  ...
  },
  {
    ...
    cards: [
      ...
      ['Marketing and service discovery','APROPOS Business Intelligence Marketplace explains the ecosystem, supports public campaigns, and routes visitors to the appropriate production service.'],
